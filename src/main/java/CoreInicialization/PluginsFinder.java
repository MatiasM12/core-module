...
public class PluginsFinder {
    ...
    public Set<TSProvider> find(String ImplPath) throws ClassNotFoundException, InstantiationException, IllegalAccessException, FileNotFoundException {
        ...
        for (File f : files) {
            if (f.getName().endsWith(".class")) {
                ...
                Class<?> cls = Class.forName("plugins." +fileName);
